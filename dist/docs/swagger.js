...
const serverUrl = env_1.default.nodeEnv === 'production' ? 'https://smallhouse.vn/api' : `http://localhost:${env_1.default.port}/api`;
const swaggerDefinition = {
    openapi: '3.0.3',
    info: {
        title: 'Small House API',
        version: '1.0.0',
        description: 'REST API cho hệ thống Small House. Bao gồm khách vãng lai, khách hàng đăng nhập và quản trị viên.'
    },
