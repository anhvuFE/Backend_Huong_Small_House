...
| Categories  | `GET /products/categories/all`, `GET /products/categories/{id}`, `POST /products/categories`, `PUT /products/categories/{id}`, `DELETE /products/categories/{id}`                 |
...
| Blogs       | `GET /blogs`, `GET /blogs/all` (admin), `GET /blogs/{id}`, `POST /blogs` (admin), `PUT /blogs/{id}` (admin), `DELETE /blogs/{id}` (admin) |
